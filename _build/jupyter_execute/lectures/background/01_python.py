...
# 
# <img src="images/bg1_f2.png" alt="Python fundamentals"  width="30%" height="100%">  
# 
# **Data Types in Python**
# 
# <img src="images/bg1_f3.png" alt="Python fundamentals"  width="50%" height="100%">  
# 
...
# 
# <img src="images/bg1_f4.png" alt="Python fundamentals"  width="50%" height="100%">  
# 
# **A FUNCTION in Python**
# 
# A _function_ in a programming provide an ability to develop a reusable code-block with an option of several operations. This means, a function have _input_ (or a set of input) and provide an (or a set) _output_.
# 
# <img src="images/bg1_f5.png" alt="Python fundamentals"  width="50%" height="100%">
# 
# _Semicolon_ (:) in line 1 and _Indentation_ after line 1 are required. **def**, **return** are _Python_ keywords. There are quite few of them.
# 
