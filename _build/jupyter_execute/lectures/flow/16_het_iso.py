...
# 
# <a href="fig2"></a><img src="images/L6_f2.png" alt="Effective K, Parallel set-up" width="200" height="400" align=right>
# 
...
# 
# ```{note}
# Feel free to change the provided values.
# ```
...
#calculation
K = (m1*K1+m2*K2+m3*K3+m4*K4+m5*K5)/m

print("Thickness of layer 1 = {} m\nThickness of layer 2 = {} m\nThickness of layer 3 = {} m\nThickness of layer 4 = {} m\nThickness of layer 5 ={} m".format(m1, m2, m3, m4, m5))
print("Conductivity of layer 1 = {} m/s\nConductivity of layer 2 = {} m/s\nConductivity of layer 3 = {} m/s\nConductivity of layer 4 = {} m/s\nConductivity of layer 5 = {} m/s".format(K1, K2, K3, K4, K5))
print("\n\033[1mSolution:\033[0m\nThe resultion hydraulic conductivity of the layer system is {:02.4} m/s.".format(K))
...
# 
# 
# <a href="fig3"></a><img src="images/L6_f3.png" alt="Effective K, Perpendicular set-up" width="200" height="400" align=right>
# 
# 
...
#solution
K = m/(m1/K1+m2/K2+m3/K3+m4/K4+m5/K5)
...
# ### Exemplary Problem on Hydraulic Resistance
# 
...
print("Hydraulic conductivity = {} m/s".format(K))
print("\n\033[1mSolution:\033[0m\nThe resulting hydraulic resistance is {:02.4} s/m.".format(R))
...
# ### Exemplary Problem on Hydraulic conductivity ellipse
# 
# Calculate the hydraulic conductivity ellipse with the provided values.
# 
# <br>
# 
# ```{note}
# You can change the values for conductivities and the angle between flow directons
# ```
...
#calculation
K = 1 /((math.cos(theta)**2/Kh)+(math.sin(theta)**2/Kv))

print("Horizontal hydraulic conductivity = {} m/s\nVertical hydraulic conductivity = {} m/s\nAngle = {} °\n".format(Kh, Kv, theta))
print("\033[1mSolution:\033[0m\nThe resulting hydraulic conductivity is \033[1m{:02.4} m/s\033[0m.".format(K))
